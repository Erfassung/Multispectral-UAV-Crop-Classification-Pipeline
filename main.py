...
def main():
    ...
    extract_parser.add_argument('--patch-size', type=int, default=256, help='Patch size in pixels')
    extract_parser.add_argument('--stride', type=int, default=128, help='Sliding window stride')
    extract_parser.add_argument('--channel-first', action='store_true', help='Store patches as (C,H,W)')
    ...
    pipeline_parser.add_argument('--patch-size', type=int, default=256, help='Patch size in pixels')
    pipeline_parser.add_argument('--stride', type=int, default=128, help='Sliding window stride')
    pipeline_parser.add_argument('--channel-first', action='store_true', help='Store patches as (C,H,W)')
